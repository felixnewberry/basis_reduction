function [err_bi, err_ep_tau_bound, err_Bhat, err_E, err_T, Ir, err_E_exact, ...
    ...
    br_ep_tau_error_dev_Nrand(B, A, N_hi, n, psi_ref, psi_low, c_low, sigma, r, p, xi_low, pc_solver, n_est)
...
sample_N = datasample(1:size(A,2), n_est, 'Replace', false); 
...
[~, ~, c_bi_N,~, ~, ~]= BR_FN(A(:,sample_N)',psi_ref(sample_N,:),c_hi,c_low,r,sigma); 
