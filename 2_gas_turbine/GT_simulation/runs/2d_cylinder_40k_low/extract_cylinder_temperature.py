...
###############################################################################
# Extract temperature on cylinder nodes
###############################################################################
...
###
## create a new 'Contour'that only has points on cylinder.  
###
contour1 = Contour(Input=mergeBlocks1)
contour1.ContourBy = ['POINTS', 'dwal']
contour1.Isosurfaces = [1e-60]
