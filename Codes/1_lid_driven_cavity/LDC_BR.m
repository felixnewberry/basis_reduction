...
% Save results: 
save('Results/LDC_results_spg_5','bi_stats', 'mean_lam_hi', 'mean_lam_ref', ...
    'mean_lam_low','N_hi',...
    'var_low_err','mean_low_err', 'r')


% Using mmv solver: 13 seconds. 
% Using spg individual solver for each point: 2:06 

% Do results check out? Time is worth it if better. 
% Put a tic toc in... 

% spg results look a little better. Go with them. 