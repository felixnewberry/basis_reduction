...
% 
% figure
% plot(x_h, efficacy_27,'-x','Color',c1,...
...
% 
% if save_on == 1
%     saveas(gcf,strcat('plots/',results_name,'eq_27_efficacy'),'epsc')
%     saveas(gcf,strcat('plots/',results_name,'eq_27_efficacy'),'fig')
% end
% 
% n_hist = 20; 
% 
...
%     saveas(gcf,strcat('plots/',results_name,'theta'),'fig')
% end
% 
% % share this
% figure
...
%     saveas(gcf,strcat('plots/',results_name,'Y'),'fig')
% end
% 
...
% sqrt([r*rho_k^2, sum(U_hat_vec.^2./Y_Nh_vec)]) 
% 
...
% 
% figure
% p1 = semilogy(x_h, sqrt(mean(err_bi_mat,2)),'-o','Color',c1,...
%     'LineWidth',LW,'MarkerSize',MS);
% hold on
% p2 = semilogy(x_h, sqrt(bound_27),'--s','Color',c3,...
%     'LineWidth',LW,'MarkerSize',MS);
% p3 = semilogy(x_h, sqrt(bound_40),'-.x','Color',c4,...
%     'LineWidth',LW,'MarkerSize',MS);
% hold off
% axis tight
% xlabel('$x$', 'interpreter', 'latex', 'fontsize', FS)
...
% 
% if save_on == 1
%     saveas(gcf,strcat('plots/',results_name,'eq_27_bound'),'epsc')
%     saveas(gcf,strcat('plots/',results_name,'eq_27_bound'),'fig')
% end
% 
...
% 
% figure
% p1 = plot(x_h, vecnorm(Y_num, 2, 2),'-o','Color',c1,...
%     'LineWidth',LW,'MarkerSize',MS);
% hold on
% p2 = plot(x_h,vecnorm(Y_den, 2, 2),'-x','Color',c2,...
%     'LineWidth',LW,'MarkerSize',MS);
% hold off
% axis tight
% xlabel('$x$', 'interpreter', 'latex', 'fontsize', FS)
...
% 
% if save_on == 1
%     saveas(gcf,strcat('plots/',results_name,'Y_ratio'),'epsc')
%     saveas(gcf,strcat('plots/',results_name,'Y_ratio'),'fig')
% end
% 
